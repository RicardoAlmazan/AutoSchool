...
public interface DatosProfesor {
    ...
    @RequestWrapper(localName = "getId", targetNamespace = "http://profesor/", className = "profesor.GetId")
    @ResponseWrapper(localName = "getIdResponse", targetNamespace = "http://profesor/", className = "profesor.GetIdResponse")
    @Action(input = "http://profesor/datosProfesor/getIdRequest", output = "http://profesor/datosProfesor/getIdResponse")
    public String getId();
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getGrupos", targetNamespace = "http://profesor/", className = "profesor.GetGrupos")
    @ResponseWrapper(localName = "getGruposResponse", targetNamespace = "http://profesor/", className = "profesor.GetGruposResponse")
    @Action(input = "http://profesor/datosProfesor/getGruposRequest", output = "http://profesor/datosProfesor/getGruposResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getTodosLosDatosProfe", targetNamespace = "http://profesor/", className = "profesor.GetTodosLosDatosProfe")
    @ResponseWrapper(localName = "getTodosLosDatosProfeResponse", targetNamespace = "http://profesor/", className = "profesor.GetTodosLosDatosProfeResponse")
    @Action(input = "http://profesor/datosProfesor/getTodosLosDatosProfeRequest", output = "http://profesor/datosProfesor/getTodosLosDatosProfeResponse")
    public String getTodosLosDatosProfe(
        @WebParam(name = "usr", targetNamespace = "")
        String usr);
