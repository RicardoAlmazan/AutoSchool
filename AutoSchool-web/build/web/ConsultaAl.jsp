...
<%
    ...
    if (sesion.getAttribute("usr") != null  &&!sesion.getAttribute("xTipo").toString().equalsIgnoreCase("2")) {
        try {
            ...
            tablita = port.consultaAlumnos(usuario);
...
<!--[if gt IE 8]><!--> <html lang="en-US"> <!--<![endif]-->
    <head>
        ...
        <title>Alumnos de <%=usuario%></title>   
    ...
    <body>
        ...
        <header>
            <div class="sticky-nav">
                ...
                <nav id="menu">
                    <ul id="menu-nav">
                        <li class="current"><a href="ConsultaAl.jsp" >Alumnos</a></li>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" onclick="document.formu.submit()"   class="btn btn-info form-control-static" value="Aceptar" name ="aceptar">
                    </div>
                </div>
